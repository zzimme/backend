...
public class MainController {
	...
	public Object createRoom(
		...
		Map<String,Object> map = roomService.createRoom(room);
	...
	public Object modifyRoom(
		...
		room.setId(id);
		Map<String,Object> map = roomService.modifyItem(room);
	...
	public Object modifyRoom(
		...
		Item item = roomService.getItem(id);
